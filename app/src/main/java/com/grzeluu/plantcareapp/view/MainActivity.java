...
public class MainActivity extends BaseActivity implements MainContract.View {
    ...
    private void initBottomNav() {
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_nav_view); // Match the ID here
        bottomNavigationView.setOnItemSelectedListener(item -> {
            int itemId = item.getItemId();
            if (itemId == R.id.bottom_my_plants) {
                openMyPlants();
                return true; // Return true to indicate the item has been handled
            } else if (itemId == R.id.bottom_discover) {
                openDiscover();
                return true;
            } else if (itemId == R.id.bottom_add_plant) {
                openAddPlant();
                return true;
            } else {
